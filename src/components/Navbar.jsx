      ...
      <div>
        <div id="mySidenav" style={{ ...sidenavStyle, width: this.state.sidenavWidth }}>
          ...
          <div>
            ...
            <Link to="/dashboard" style={sidenavLinkStyle}><FaBriefcase /> Dashboard</Link>
            <Link to="/profile" style={sidenavLinkStyle}><FaUser /> Updated Profile</Link>
            ...
            <Link to="/careercenter" style={sidenavLinkStyle}><FaUsers /> Create Group</Link>
